# Product Guidelines: Claude Code Skills
...
- **Standard Skill Layout**: Adhere strictly to the established Claude Code skill structure (e.g., `README.md`, `SKILL.md`) to ensure consistent behavior across all skills in the collection.

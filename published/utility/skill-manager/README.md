...
- **Workspace Ignore Management**: Installing `skill-manager` updates the project `.gitignore` to ignore the generated Gemini workspace files it adds.
  It also ignores the installed Gemini skills plus managed Codex and Claude companion skill folders.
...
- `skill-manager` updates the project `.gitignore` to ignore managed skill-manager artifacts in `.gemini/skills/`, `.gemini/commands/`, `.gemini/settings.json`, `.codex/skills/`, and `.claude/skills/`.

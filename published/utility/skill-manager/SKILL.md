...
## Integration
This skill ensures that official skills are properly junctioned and their `post_install.py` hooks are executed to maintain project-level workflow consistency.
